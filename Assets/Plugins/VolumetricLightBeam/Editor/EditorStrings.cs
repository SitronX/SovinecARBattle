...
namespace VLB
{
    public static class EditorStrings
    {
        ...
        public static class Beam
        {
            ...
            public const string IntensityMultiplier = "Multiplier to modulate the spotlight intensity.";
            ...
            public const string SpotAngleMultiplier = "Multiplier to modulate the spotlight spot angle.";
            ...
            public const string FallOffEndMultiplier = "Distance multiplier to modulate the spotlight range.";
