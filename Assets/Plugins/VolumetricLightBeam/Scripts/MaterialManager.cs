...
namespace VLB
{
    public static class MaterialManager
    {
        ...
        public const int staticPropertiesCount = (int)BlendingMode.Count * (int)Noise3D.Count * (int)DepthBlend.Count * (int)ColorGradient.Count * (int)DynamicOcclusion.Count * (int)MeshSkewing.Count * (int)ShaderAccuracy.Count;
        ...
        {
            public Material[] materials = new Material[staticPropertiesCount];
        }
        ...
        public static Material GetInstancedMaterial(uint groupID, ref StaticProperties staticProps) // pass StaticProperties by ref to avoid per value arg copy
        {
            ...
            Debug.Assert(matID < staticPropertiesCount);
