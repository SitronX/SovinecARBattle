...
namespace VLB
{
    ...
    public partial class VolumetricLightBeam : MonoBehaviour
    {
...
#if UNITY_EDITOR
        public Color ComputeColorAtDepth(float depthRatio)
        {
        ...
        /// </summary>
        [Range(Consts.Beam.GlareMin, Consts.Beam.GlareMax)]
        public float glareFrontal = Consts.Beam.GlareFrontalDefault;

        /// <summary>
        /// Boost intensity factor when looking at the beam from behind.
        /// </summary>
        [Range(Consts.Beam.GlareMin, Consts.Beam.GlareMax)]
        public float glareBehind = Consts.Beam.GlareBehindDefault;
        ...
        public Vector3      beamGlobalForward           { get { return transform.localToWorldMatrix.MultiplyVector(beamLocalForward); } }
...
#pragma warning restore 0414
        ...
        public void Reset()
        {
            ...
            glareFrontal = Consts.Beam.GlareFrontalDefault;
            glareBehind = Consts.Beam.GlareBehindDefault;
        ...
        void AssignPropertiesFromAttachedSpotLight()
        {
            ...
            if (lightSpot)
            {
                Debug.Assert(lightSpot.type == LightType.Spot);
        ...
        void ClampProperties()
        {
            ...
            glareBehind = Mathf.Clamp(glareBehind, Consts.Beam.GlareMin, Consts.Beam.GlareMax);
            glareFrontal = Mathf.Clamp(glareFrontal, Consts.Beam.GlareMin, Consts.Beam.GlareMax);
...
#if DEBUG_GLOBAL_FORWARD
            Debug.DrawLine(transform.position, transform.position + beamGlobalForward, Color.blue);
            Debug.DrawLine(transform.position, transform.position + raycastGlobalForward, Color.magenta);
#endif
